...
int saveReturnType(NODE * node)
{
    ...
    if (0 == strcmp(atom->description,"NUMBER"))
    {
        strcpy(g_return_stmt_types[g_return_stmt_count], "int");
    }
    else
    {
        if (0 == strcmp(atom->description,"TEXT"))
        {
            strcpy(g_return_stmt_types[g_return_stmt_count], "string");
        }
        else
        {
            if (0 == strcmp(atom->description,"Identifier"))
            {
                strcpy(g_return_stmt_types[g_return_stmt_count], getTypeFromTSByIdentifier(atom->value, "VARIABLE", g_current_scope));
            }
        }
    }
...
void saveExpressionType(NODE* node)
{
    ...
    if (0 == strcmp(node->description, "Rvalue") || 0 == strcmp(node->description, "Addition") || 0 == strcmp(node->description, "BooleanRvalue"))
    {
