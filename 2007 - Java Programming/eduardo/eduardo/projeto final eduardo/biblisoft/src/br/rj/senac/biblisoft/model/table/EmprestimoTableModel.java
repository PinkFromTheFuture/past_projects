...
public class EmprestimoTableModel extends AbstractTableModel {
	...
	public static String[] colunas = { "ID", "EXEMPLAR", "USUARIO", "BIBLIOTECARIO", "LIMITE PARA ENTREGA", "DATA DA DEVOLUCAO" };

	public EmprestimoTableModel(ArrayList<String[]> dados, String[] colunas) {
		setLinhas(dados);
		setColunas(colunas);
	}
